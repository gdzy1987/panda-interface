...
// TemplateMod returns template mod.
func TemplateMod() string {
	...
	// $GOPATH/src/github.com/PandaGoAdmin/panda-template-go
	return filepath.Join(gopath, "src", "github.com", "PandaGoAdmin", "panda-template-go")
}
