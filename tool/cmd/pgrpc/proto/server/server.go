...
var CmdServer = &cobra.Command{
	...
	Long:  "Generate the proto Server implementations. Example: panda proto server api/xxx.proto -target-dir=pkg/service",
	Run:   run,
}
...
func run(cmd *cobra.Command, args []string) {
	if len(args) == 0 {
		fmt.Fprintln(os.Stderr, "Please specify the proto file. Example: panda proto server api/xxx.proto")
		return
	}
